/*-----------------------------------------------------------------------------
    ...
    Date of recording: 06/29/2021 06:21:52
    Flow details:
...
public class flow implements NsFlow
{
    public int execute(NSApi nsApi) throws Exception
    {
        ...
        status = nsApi.ns_page_think_time(8.463);

        //Page Auto split for Image Link 'Login' Clicked by User
        status = nsApi.ns_start_transaction("login");
        status = nsApi.ns_web_url ("login",
            "URL=http://10.10.30.207:8080/cgi-bin/login?userSession=75893.0884568651DQADHfApHDHfcDtccpfAttcf&username=cavisson&password=cavisson&login.x=40&login.y=20&JSFormSubmit=off",
            "HEADER=Upgrade-Insecure-Requests:1",
            "HEADER=Accept-Language:en-US,en;q=0.9",
            INLINE_URLS,
                "URL=http://10.10.30.207:8080/tours/Merc10-dev/images/banner_animated.gif", "HEADER=Accept-Language:en-US,en;q=0.9", END_INLINE,
        ...
        status = nsApi.ns_page_think_time(2.096);
        ...
        status = nsApi.ns_page_think_time(3.071);
        ...
        status = nsApi.ns_web_url ("findflight",
            "URL=http://10.10.30.207:8080/cgi-bin/findflight?depart=Acapulco&departDate=07-01-2021&arrive=Acapulco&returnDate=07-02-2021&numPassengers=1&seatPref=None&seatType=Coach&findFlights.x=80&findFlights.y=14",
            "HEADER=Upgrade-Insecure-Requests:1",
            "HEADER=Accept-Language:en-US,en;q=0.9",
            INLINE_URLS,
                "URL=http://10.10.30.207:8080/tours/Merc10-dev/images/banner_animated.gif", "HEADER=Accept-Language:en-US,en;q=0.9", END_INLINE,
        ...
        status = nsApi.ns_page_think_time(1.574);
        ...
        status = nsApi.ns_page_think_time(1.777);
        ...
        status = nsApi.ns_web_url ("findflight_3",
            "URL=http://10.10.30.207:8080/cgi-bin/findflight?firstName=Tiger&lastName=Scott&address1=4261+Stevenson+Blvd.&address2=Fremont%2C+CA+94538&pass1=Scott+Tiger&creditCard=&expDate=&oldCCOption=&numPassengers=1&seatType=Coach&seatPref=None&outboundFlight=000%7C0%7C07-01-2021&advanceDiscount=&buyFlights.x=28&buyFlights.y=8&.cgifields=saveCC",
            "HEADER=Upgrade-Insecure-Requests:1",
            "HEADER=Accept-Language:en-US,en;q=0.9",
            INLINE_URLS,
                "URL=http://10.10.30.207:8080/tours/Merc10-dev/images/banner_animated.gif", "HEADER=Accept-Language:en-US,en;q=0.9", END_INLINE,
        ...
        status = nsApi.ns_page_think_time(1.921);
        ...
        status = nsApi.ns_page_think_time(1.787);
